...
<div class="container mx-auto px-4 md:px-6 py-6">
    <h1 class="text-2xl font-semibold text-gray-900 mb-6">Edit Class Category</h1>

    <div class="bg-gray-50 p-6 rounded-lg shadow-lg border border-gray-200">
        <form action="{{ route('class_categories.update', $class_category) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col space-y-2">
                ...
                <input 
                    ...
                    value="{{ $class_category->class_name }}" 
            ...
            <div class="flex flex-col space-y-2">
                ...
                <textarea 
                    ...
                    rows="4">{{ $class_category->description }}</textarea>
            </div>
